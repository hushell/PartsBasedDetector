...
pa = [0 1 1 3 4 5 6 7 8 1 10 11 12 13 14 15];

% need to be specified
name = 'NClass';
dir = '/scratch/working/AVATOL/datasets/Ventral_View/Noctilio/';

% Spatial resolution of HOG cell, interms of pixel width and hieght
sbin = 8;

colorset = {'g','g','r','r','r','r','r','r','r','b','b','b','b','b','b','b'};
