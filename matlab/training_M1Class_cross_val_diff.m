...
pa = [0 1 2 3 4 5 1 7 8 9 10];

% need to be specified
name = 'M1Class_diff';
dir = '/scratch/working/AVATOL/datasets/Ventral_View/Molossus/';

% Spatial resolution of HOG cell, interms of pixel width and hieght
sbin = 8;

colorset = {'g','r','r','r','r','r','b','b','b','b','b'};
...
show_data = 0;
if (show_data == 1)
    pos = load_bboxs(20,length(pa),[dir,'Molossus.annotation']);
...
posAll = load_bboxs(20,length(pa),[dir,'Molossus.annotation']);
